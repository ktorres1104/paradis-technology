export const translations = {
  en: {
    ...
    hero: {
      badge: 'Data & AI Consulting · Puerto Rico',
    ...
    contact: {
      ...
      messagePlaceholder: 'What challenges are you facing? What would success look like?',
      sending: 'Sending...',
      send: 'Send Message',
    ...
    demos: {
      ...
      chatbot: {
        ...
        assistantLabel: 'Virtual Assistant',
        businessName: 'Sunny Salon',
        script: [
          { role: 'bot', text: 'Hi! Welcome to Sunny Salon 💇 How can I help you today?', dur: 500 },
          { role: 'user', text: "Hi, I'd like to know what services you offer", dur: 1500 },
          { role: 'typing', dur: 1000 },
          {
            role: 'bot',
            text: 'Of course! We offer haircuts, color, manicures, and facial treatments. Which one interests you most?',
            dur: 2800,
          },
          { role: 'user', text: "I'm interested in a haircut and color, how much do they cost?", dur: 1700 },
          { role: 'typing', dur: 1000 },
          {
            role: 'bot',
            text: 'A haircut starts at $25, and full color starts at $65. It depends on hair length. Would you like to book an appointment?',
            dur: 3000,
          },
          { role: 'user', text: 'Yes, what days do you have available this week?', dur: 1800 },
          { role: 'typing', dur: 1000 },
          { role: 'bot', text: 'We have openings Tuesday, Thursday, and Saturday. Which works best for you?', dur: 2400 },
          { role: 'user', text: 'Saturday is perfect. Thanks for all the info!', dur: 2200 },
          { role: 'typing', dur: 900 },
          {
            role: 'bot',
            text: "You're very welcome! I've confirmed your appointment for Saturday. Any other questions, I'm here. 💇",
            dur: 3400,
          },
        ],
      },
      dashboard: {
        ...
        title: 'Your business, in a single view',
        subtitle:
          'Sales, performance analysis, and overall business health, all in one view. Watch the metrics update across 7, 30, and 90 days.',
        demoLabel: 'Automatic Demo · Dashboard',
        panelTitle: 'General Performance',
        kpis: { revenue: 'Revenue', orders: 'Orders', avgTicket: 'Avg. Ticket', retention: 'Retention' },
        vsLabel: 'vs. previous period',
        checklist: ['Inventory synced', 'Bot responding in <2 min', 'Reports up to date'],
        datasets: {
          '7D': {
          ...
          '90D': {
            ...
            bars: [
              { label: 'Month 1', value: 29800 },
              { label: 'Month 2', value: 33100 },
              { label: 'Month 3', value: 38400 },
            ],
          },
        },
      },
      automation: {
        ...
        flows: [
          {
            name: 'WhatsApp Bot → CRM',
            nodes: [
              { title: 'Message received', desc: 'Comes in through WhatsApp or Instagram' },
              { title: 'Classifies intent', desc: 'The AI understands what the customer needs' },
              { title: 'Checks the system', desc: 'Looks up inventory, calendar, or CRM' },
              { title: 'Generates a response', desc: "Written in your brand's tone" },
              { title: 'Updates and replies', desc: 'Saves the record and answers the customer' },
            ],
          },
          {
            name: 'New Order → Daily Report',
            nodes: [
              { title: 'New order', desc: 'Registered in the store or POS' },
              { title: 'Checks inventory', desc: 'Deducts units automatically' },
              { title: 'Updates spreadsheet', desc: 'Google Sheets always up to date' },
              { title: 'Notifies the team', desc: "Alerts if something is running low" },
              { title: 'Generates daily report', desc: 'Automatic summary every night' },
            ],
          },
        ],
      },
      consulting: {
        eyebrow: 'Consulting',
        title: "Not sure where to start? That's okay.",
        subtitle:
          'Answer 3 quick questions and we tell you where we recommend you start. That is how a real consulting session begins: understanding your context before proposing anything.',
        recommendedLabel: 'We recommend',
        bookCall: 'Book your free call',
        tryAgain: 'Try again',
        questions: [
          {
            q: 'How do you manage your data today?',
            options: [
              'Everything in Excel or on paper',
              "I have several tools that don't talk to each other",
              'I already have dashboards, but I want more',
            ],
          },
          {
            q: "What's your biggest operational headache?",
            options: [
              'Repetitive tasks that eat up time',
              "I'm not sure what's happening with my numbers",
              "I want to use AI, but don't know where to start",
            ],
          },
          {
            q: 'How many people are on your team?',
            options: ['Just me, or 1–3 people', '4–15 people', '16 or more'],
          },
        ],
        recommendations: [
          {
            title: 'Automation Plan',
            text: "Based on what you've told us, the fastest impact comes from automating repetitive tasks (messages, updates, order follow-ups) so your team gets hours back every week.",
          },
          {
            title: 'Performance Dashboard Plan',
      ...
      player: { pause: 'Pause', play: 'Play', restart: 'Restart' },
    },
  },
  es: {
    nav: {
    ...
    contact: {
      ...
      messagePlaceholder: '¿Qué retos estás enfrentando? ¿Cómo se vería el éxito?',
      sending: 'Enviando...',
      send: 'Enviar Mensaje',
    ...
    footer: {
      tagline: 'Hacemos que la IA y los datos sean prácticos y accesibles para negocios en Puerto Rico.',
      rights: 'Todos los derechos reservados.',
      location: 'Puerto Rico, EE. UU.',
    },
    demos: {
      eyebrow: 'Pruébalo Tú Mismo',
      title: 'Nuestras Herramientas en Acción',
      subtitle:
      ...
      chatbot: {
        ...
        businessName: 'Salón Sol',
        script: [
          { role: 'bot', text: '¡Hola! Bienvenido/a a Salón Sol 💇 ¿En qué puedo ayudarte hoy?', dur: 500 },
          { role: 'user', text: 'Hola, quisiera saber qué servicios ofrecen', dur: 1500 },
          { role: 'typing', dur: 1000 },
          {
            role: 'bot',
            text: 'Claro que sí. Ofrecemos corte, color, manicura y tratamientos faciales. ¿Cuál te interesa más?',
            dur: 2800,
          },
          ...
          {
            role: 'bot',
            text: 'Un corte va desde $25, y color completo desde $65. Depende del largo del cabello. ¿Te gustaría agendar una cita?',
            dur: 3000,
          },
          ...
          {
            role: 'bot',
            text: '¡Con mucho gusto! Te dejo confirmada tu cita para el sábado. Cualquier otra pregunta, aquí estoy. 💇',
            dur: 3400,
          },
        ],
      },
      dashboard: {
        eyebrow: 'Dashboards de Performance',
        title: 'Tu negocio, en una sola vista',
        subtitle:
          'Ventas, análisis de performance y estado general del negocio, todo en una sola vista. Observa cómo se actualizan las métricas entre 7, 30 y 90 días.',
        demoLabel: 'Demo automático · Dashboard',
        panelTitle: 'Performance General',
        kpis: { revenue: 'Ingresos', orders: 'Órdenes', avgTicket: 'Ticket Prom.', retention: 'Retención' },
        vsLabel: 'vs. periodo anterior',
        checklist: ['Inventario sincronizado', 'Bot respondiendo en <2 min', 'Reportes al día'],
        datasets: {
          '7D': {
            kpis: { revenue: 8420, orders: 312, avgTicket: 27, retention: 64 },
            deltas: { revenue: 4.2, orders: 2.1, avgTicket: -1.4, retention: 1.8 },
            bars: [
              ...
              { label: 'Mié', value: 890 },
              { label: 'Jue', value: 1340 },
              { label: 'Vie', value: 1780 },
              { label: 'Sáb', value: 1620 },
              { label: 'Dom', value: 690 },
            ],
          },
          '30D': {
          ...
          '90D': {
            ...
            deltas: { revenue: 18.9, orders: 15.2, avgTicket: 0.6, retention: 5.4 },
            bars: [
              { label: 'Mes 1', value: 29800 },
              { label: 'Mes 2', value: 33100 },
              { label: 'Mes 3', value: 38400 },
            ],
          },
        },
      },
        ...
        flows: [
          {
            ...
            nodes: [
              { title: 'Mensaje recibido', desc: 'Llega por WhatsApp o Instagram' },
              { title: 'Clasifica intención', desc: 'La IA entiende qué necesita el cliente' },
              { title: 'Consulta el sistema', desc: 'Revisa inventario, calendario o CRM' },
              { title: 'Genera respuesta', desc: 'Redacta con el tono de tu marca' },
              { title: 'Actualiza y responde', desc: 'Guarda el registro y contesta al cliente' },
            ],
          },
          {
            name: 'Nueva orden → Reporte diario',
            nodes: [
              { title: 'Nueva orden', desc: 'Se registra en la tienda o el POS' },
              { title: 'Verifica inventario', desc: 'Descuenta unidades automáticamente' },
              { title: 'Actualiza hoja de cálculo', desc: 'Google Sheets siempre al día' },
              { title: 'Notifica al equipo', desc: 'Avisa si algo está por agotarse' },
              { title: 'Genera reporte diario', desc: 'Resumen automático cada noche' },
            ],
          },
        ],
      },
      consulting: {
        eyebrow: 'Consultoría',
        title: 'No sabes por dónde empezar. Está bien.',
        subtitle:
          'Contesta 3 preguntas rápidas y te decimos por dónde recomendamos que empieces. Así arranca una sesión real de consultoría: entendiendo tu contexto antes de proponer nada.',
        recommendedLabel: 'Te recomendamos',
        ...
        questions: [
          {
            ...
            options: [
              'Todo en Excel o papel',
              'Tengo varias herramientas que no se hablan entre sí',
              'Ya tengo dashboards, pero quiero más',
            ],
          },
          {
            ...
            options: [
              ...
              'No sé bien qué está pasando con mis números',
      ...
      player: { pause: 'Pausar', play: 'Reproducir', restart: 'Reiniciar' },
    },
  },
}
